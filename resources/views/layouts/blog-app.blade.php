...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="{{asset('libraries/clean-blog/vendor/bootstrap/css/bootstrap.min.css')}}" rel="stylesheet">
...
<body>
    ...
    <header class="intro-header" style="background-image: url('libraries/clean-blog/img/home-bg.jpg')">
        <div class="container">
            <div class="row">
